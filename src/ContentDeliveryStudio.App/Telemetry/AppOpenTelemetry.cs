...
namespace ContentDeliveryStudio.App.Telemetry;
...
internal static class AppOpenTelemetry
{
    ...
    public const string DefaultServiceName = "ContentDeliveryStudio.App";
    ...
    public static void AddContentDeliveryStudioOpenTelemetry(this IHostApplicationBuilder builder)
    {
