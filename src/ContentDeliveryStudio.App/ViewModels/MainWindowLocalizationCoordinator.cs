...
public sealed class MainWindowLocalizationCoordinator
{
    ...
    public MainWindowLocalizationPayload BuildPayload()
    {
        return new MainWindowLocalizationPayload
        {
            ...
            MoveGenerationTaskUpText = Text(LocalizationKey.MoveGenerationTaskUp),
            MoveGenerationTaskDownText = Text(LocalizationKey.MoveGenerationTaskDown),
            QueueItemColumn = Text(LocalizationKey.QueueItemColumn),
            QueuePositionColumn = Text(LocalizationKey.QueuePositionColumn),
...
public sealed class MainWindowLocalizationPayload
{
    ...
    public string MoveGenerationTaskUpText { get; init; } = string.Empty;
    public string MoveGenerationTaskDownText { get; init; } = string.Empty;
    public string QueueItemColumn { get; init; } = string.Empty;
    public string QueuePositionColumn { get; init; } = string.Empty;
