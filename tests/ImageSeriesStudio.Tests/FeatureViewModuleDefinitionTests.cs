...
public sealed class FeatureViewModuleDefinitionTests
{
    ...
    public void FeatureViewModuleDefinition_CapturesWpfViewModelLocalizationCommandsAndFakeTests()
    {
        var module = FeatureViewModuleDefinition.Create(
            ...
            "ImageSeriesStudio.App.Views.SourceListView",
            "ImageSeriesStudio.App.ViewModels.SourceListViewModel",
        ...
        Assert.Equal("ImageSeriesStudio.App.Views.SourceListView", module.ViewTypeName);
        Assert.Equal("ImageSeriesStudio.App.ViewModels.SourceListViewModel", module.ViewModelTypeName);
    ...
    public void FeatureViewModuleDefinition_RejectsUnknownModulesSlotsAndMissingFakeTests()
    {
        Assert.Throws<InvalidOperationException>(() =>
            FeatureViewModuleDefinition.Create(
                ...
                "ImageSeriesStudio.App.Views.MissingView",
                "ImageSeriesStudio.App.ViewModels.MissingViewModel",
                ["Missing.Title"],
                ["Run"],
                ["MissingFakeTest"]));
        Assert.Throws<ArgumentException>(() =>
            FeatureViewModuleDefinition.Create(
                ...
                "source-ingestion",
                "PermanentGlobalTab",
                "ImageSeriesStudio.App.Views.BadView",
                "ImageSeriesStudio.App.ViewModels.BadViewModel",
                ["Bad.Title"],
                ["Run"],
                ["BadFakeTest"]));
        Assert.Throws<ArgumentException>(() =>
            FeatureViewModuleDefinition.Create(
                ...
                "ImageSeriesStudio.App.Views.SourceActivityView",
                "ImageSeriesStudio.App.ViewModels.SourceActivityViewModel",
                ["Sources.Activity"],
                ["RefreshActivity"],
                []));
    }
