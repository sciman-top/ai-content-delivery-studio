...
- [x] Add built-in document-review industry, renderer, and review-rubric pack IDs.
- [x] Wire the document-review workflow pack to those policy packs.
- [x] Extend built-in catalog tests to assert the document-review policy links.
...
- [x] Update any pack-count or contract assertions affected by the document-review scenario policy packs.
- [x] Update backlog wording so the document-review scenario slice is no longer outstanding once it lands.
