...
- Prefer a second split step inside large stage views once one user control starts carrying multiple dense regions; keep list-heavy brief, review, or delivery sections eligible for their own child controls before changing shell structure.
