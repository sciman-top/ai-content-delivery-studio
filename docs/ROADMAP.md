...
- Continue pack and policy modeling hardening beyond the generic image-series, article-illustration, and document-review-translation scenarios only when each scenario-specific slice has a repo-owned spec and a bounded implementation plan.
