# 20260710 Agent Rule Contract v2 - ai-content-delivery-studio
...
## Verification
- `python D:\CODE\governed-ai-coding-runtime\scripts\verify-target-project-rules.py --targets ai-content-delivery-studio --require-all`
